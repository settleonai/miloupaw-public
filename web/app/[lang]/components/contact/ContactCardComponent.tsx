...
const ContactCardComponent: FunctionComponent<ContactCardComponentProps> = ({
  icon,
  title,
  description,
  language,
  ...
  return (
    <div className="snap-start shrink-0  relative w-[280px] h-[190px] bg-secondary-100 rounded-lg  py-7">
      ...
      <div className="flex flex-col items-center  ">
        <span
          className={`pt-8 text-3xl  font-semibold text-primary-default ${
            language === "en" ? "font-display" : ""
          }`}
        >
          {title}
        </span>
