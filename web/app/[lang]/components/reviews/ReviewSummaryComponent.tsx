...
type ReviewSummaryComponentProps = {
  dictionary: any;
  lang: string;
};

const ReviewSummaryComponent: FunctionComponent<
        ...
        >
          <h2
            className={`text-primary-default ${
              lang !== "fa" ? "font-display text-left" : "text-right"
            } font-bold text-4xl tracking-wide uppercase `}
          >
            {dictionary.reviews_component.title}
          </h2>
          ...
          >
            {dictionary.reviews_component.description}
          </p>
        </div>

        <div className="mt-10" dir={`${lang !== "fa" ? "ltr" : "rtl"}`}>
